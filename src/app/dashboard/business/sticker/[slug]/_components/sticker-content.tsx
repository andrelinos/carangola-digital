  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-20 -bottom-40 size-[500px] rounded-full bg-violet-600/20 blur-[120px]" />
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center px-4 py-10">
        ...
        <div className="mb-12 w-full max-w-2xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-md font-medium text-slate-400 text-sm">
            Baixe e compartilhe nos seus Stories para atrair mais clientes ao
            seu negócio.
          </p>
        </div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  height: 568 /* 9:16 */,
                  background:
                    'linear-gradient(160deg,#1e1b4b 0%,#1e3a8a 40%,#4c1d95 100%)',
                  display: 'flex',
              ...
              >
                ...
                >
                  <Sparkles
                    style={{ width: 11, height: 11, color: '#fde68a' }}
                  />
                  <span
                    style={{
                ...
                <h2
                  style={{
                    ...
                    fontWeight: 900,
                    fontSize:
                      establishmentName.length > 18
                        ? '22px'
                        : establishmentName.length > 12
                          ? '26px'
                          : '30px',
                    color: 'white',
                    textAlign: 'center',
          ...
          <div className="flex w-full max-w-sm flex-col gap-6 lg:pt-4">
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="group relative flex h-14 w-full items-center justify-center overflow-hidden rounded-2xl font-black text-sm text-white uppercase tracking-widest transition-all disabled:opacity-60"
                style={{
                  background: 'linear-gradient(135deg,#ec4899,#8b5cf6,#3b82f6)',
                }}
              >
            ...
            <div className="rounded-2xl border border-amber-500/20 bg-amber-500/10 p-4">
              ...
              <p className="mt-1.5 font-medium text-amber-200/80 text-xs leading-relaxed">
                Salve a imagem e adicione-a ao seu Story como figurinha ou
                fundo. Marque{' '}
