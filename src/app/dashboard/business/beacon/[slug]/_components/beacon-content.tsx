        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 font-medium text-slate-500 text-sm dark:text-slate-400">
              Ative o sinalizador para aparecer com destaque para clientes em um
              raio de 5km.
            </p>
          </div>
            ...
            <button
              ...
              className={`relative inline-flex h-12 w-48 shrink-0 items-center justify-center rounded-full font-bold text-sm text-white transition-all ${
                isActive
                  ...
                  : 'bg-emerald-500 shadow-emerald-500/30 shadow-lg hover:bg-emerald-600'
              }`}
            >
      ...
      {!hasLocation ? (
        <div className="flex h-[400px] flex-col items-center justify-center rounded-3xl border border-slate-300 border-dashed bg-slate-50 p-8 text-center dark:border-slate-800 dark:bg-slate-900/50">
          ...
          <p className="mt-2 max-w-md text-slate-500 text-sm">
            Para aparecer no mapa, você precisa adicionar o endereço completo
            com as coordenadas (latitude e longitude) no seu perfil.
          </p>
          <Link
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-6">
            <div
              className={`rounded-3xl border p-6 transition-colors ${isActive ? 'border-emerald-200 bg-emerald-50 dark:border-emerald-900/50 dark:bg-emerald-950/20' : 'border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-900'}`}
            >
              <div className="mb-4 flex items-center justify-between">
                ...
                <div className="relative flex h-3 w-3">
                  ...
                  <span
                    className={`relative inline-flex h-3 w-3 rounded-full ${isActive ? 'bg-emerald-500' : 'bg-slate-400'}`}
                  ></span>
                </div>
              </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-950">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <div className="flex size-6 shrink-0 items-center justify-center rounded-full bg-blue-100 font-bold text-blue-600 text-xs dark:bg-blue-900/30 dark:text-blue-400">
                    1
                  </div>
                  <p className="text-slate-600 text-sm leading-tight dark:text-slate-400">
                    O usuário abre o app e acessa a aba "Locais Próximos".
                  </p>
                </li>
                <li className="flex gap-3">
                  <div className="flex size-6 shrink-0 items-center justify-center rounded-full bg-blue-100 font-bold text-blue-600 text-xs dark:bg-blue-900/30 dark:text-blue-400">
                  ...
                  <p className="text-slate-600 text-sm leading-tight dark:text-slate-400">
                    Calculamos a distância e buscamos negócios num raio de 5km.
                  </p>
                </li>
                <li className="flex gap-3">
                  <div className="flex size-6 shrink-0 items-center justify-center rounded-full bg-blue-100 font-bold text-blue-600 text-xs dark:bg-blue-900/30 dark:text-blue-400">
                  ...
                  <p className="text-slate-600 text-sm leading-tight dark:text-slate-400">
                    Negócios com Beacon Ativo pulsam em verde, atraindo o clique
                    imediato.
                  </p>
                </li>
              </ul>
