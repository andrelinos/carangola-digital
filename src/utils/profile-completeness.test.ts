...
const fullProfile: Partial<ProfileDataProps> = {
  ...
  businessPhones: [{ phone: '32988887777', title: 'WhatsApp', nameContact: 'Test', isWhatsapp: true, isOnlyWhatsapp: false }],
  businessAddresses: [
    {
...
describe('calculateProfileCompleteness', () => {
  ...
  describe('checagem individual de itens', () => {
    ...
    it('marca "phones" completo quando há pelo menos 1 telefone', () => {
      const profile = {
        ...emptyProfile,
        businessPhones: [{ phone: '32988887777', title: 'Fixo', nameContact: 'Test', isWhatsapp: false, isOnlyWhatsapp: false }],
      }
      const { items } = calculateProfileCompleteness(
        profile as ProfileDataProps
      )
