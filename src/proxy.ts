...
export default function proxy(request: NextRequest) {
  ...
  const scriptSrc = isProduction
    ? "'self' 'unsafe-inline' https://*.googletagmanager.com https://*.google-analytics.com"
    : "'self' 'unsafe-inline' 'unsafe-eval' https://*.googletagmanager.com https://*.google-analytics.com"
  ...
  const securityHeaders = {
    'Content-Security-Policy': [
      ...
      "img-src 'self' data: blob: https://*.google-analytics.com https://*.googletagmanager.com https://*.carangoladigital.com.br https://carangoladigital.com.br https://storage.googleapis.com https://firebasestorage.googleapis.com",
      "font-src 'self' data: https://fonts.gstatic.com",
      // ATENÇÃO: Adicione aqui as APIs externas que seu frontend consome (Firebase, Supabase, APIs de pagamento, etc)
      "connect-src 'self' https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://identitytoolkit.googleapis.com",
