        ...
        <div className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-6 max-w-xl text-lg text-primary-foreground/80 lg:text-xl">
              Aumente sua visibilidade, gerencie seus horários e conecte-se com
              novos clientes diariamente através da nossa plataforma.
            </p>
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4 lg:justify-start">
              ...
              <div className="flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2 backdrop-blur-sm">
                ...
                <span className="font-medium text-sm">Gestão Completa</span>
              </div>
            </div>
